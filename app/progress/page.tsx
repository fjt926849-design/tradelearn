...
export default function ProgressPage() {
  ...
  const chapterStats = useMemo(
    () => termLibraryChapters.map((chapter) => {
      const mastered = chapter.terms.filter((term) => progressById.get(term.id) === "mastered").length;
      const learning = chapter.terms.filter((term) => progressById.get(term.id) === "learning").length;
