...
export const curriculumParts: CurriculumPart[] = [
  {
    ...
    chapters: [{ ...chapter("00", "导论", "认识国际贸易业务、参与者与基本流程。", "partial", {
  ...
  },
  {
    ...
    chapters: [
      chapter("11", "国际商务谈判", "学习询盘、报价沟通、谈判策略和商务回复。", "partial", { workflowStages: ["询盘", "谈判"], prerequisites: ["ch-01"], contentPlan: ["询盘、发盘、还盘与接受的沟通边界", "价格、交期、付款和质量条款的谈判顺序", "跨文化沟通与书面留痕"], practicePlan: ["回复一封含糊询盘并补齐关键信息", "针对客户压价写出三轮谈判回复"] }),
  ...
  },
  {
    ...
    chapters: [
      chapter("15", "独家经销与独家代理", "比较经销与代理的责任、收益和风险。", "partial", { workflowStages: ["合同", "履约"], prerequisites: ["ch-04"], contentPlan: ["经销与代理的法律关系", "独家区域、最低采购量和业绩条款", "渠道冲突与终止安排"], practicePlan: ["为某区域渠道选择经销或代理", "补写独家合作的三条核心条款"] }),
      chapter("16", "寄售与展卖", "理解寄售、展卖的货权和结算特点。", "partial", { workflowStages: ["履约", "结算"], prerequisites: ["ch-08"], contentPlan: ["货权保留、库存风险与销售回款", "寄售库存和展卖费用的核算", "退货、损耗与保险责任"], practicePlan: ["设计寄售库存对账表", "判断展卖费用由哪一方承担"] }),
      chapter("17", "招标投标与拍卖", "掌握竞价交易流程和文件要求。", "partial", { workflowStages: ["询盘", "合同"], prerequisites: ["ch-11"], contentPlan: ["招标文件、投标保证与评标", "拍卖竞价、成交确认与付款", "合规审查与异常报价识别"], practicePlan: ["从招标文件提取资格和交付要求", "比较两份投标方案的总成本"] }),
      chapter("18", "期货交易与套期保值", "理解价格风险和套期保值基本方法。", "partial", { workflowStages: ["报价", "风险"], prerequisites: ["ch-07"], contentPlan: ["现货价格风险与期货合约", "买入、卖出套期保值的基本逻辑", "基差、保证金与风险限额"], practicePlan: ["为铜材订单选择套保方向", "用简单数据计算套保损益"] }),
      chapter("19", "对销贸易", "认识易货、补偿贸易等对销方式。", "partial", { workflowStages: ["合同", "结算"], prerequisites: ["ch-08"], contentPlan: ["易货、互购和补偿贸易的结构", "对销额度、结算与履约风险", "合同关联条款的交叉违约"], practicePlan: ["画出对销交易的资金与货物流", "识别一项对销安排的合规风险"] }),
      chapter("20", "加工贸易", "理解加工贸易流程、监管和风险。", "partial", { workflowStages: ["履约", "合规"], prerequisites: ["ch-13"], contentPlan: ["来料加工与进料加工", "料件监管、核销和单耗管理", "关务、成本与交付协同"], practicePlan: ["根据订单计算加工贸易单耗", "列出加工贸易交付前的合规检查项"] }),
    ],
  },
  {
    id: "part-5",
    ...
    chapters: [
      chapter("21", "跨境电商基本概念", "认识跨境电商生态、参与方和业务边界。", "partial", { workflowStages: ["询盘", "履约", "合规"], prerequisites: ["ch-04"], contentPlan: ["平台、独立站与服务商生态", "B2C、B2B及数字贸易边界", "消费者保护、数据和知识产权风险"], practicePlan: ["为一个产品选择交易模式", "检查商品页是否缺少合规信息"] }),
      chapter("22", "跨境电商模式与运营", "完成选品、定价、履约、售后和合规运营。", "partial", { workflowStages: ["报价", "履约", "结算", "合规"], prerequisites: ["ch-21"], contentPlan: ["选品、定价与平台费用", "支付、国际物流和海外仓", "售后、评价、税务与持续运营"], practicePlan: ["计算一件商品的跨境电商到手成本", "设计从下单到售后的履约清单"] }),
    ],
  },
];
