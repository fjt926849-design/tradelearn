...
const baseTradeGlossary: TradeGlossaryBaseEntry[] = [
  ...
  { id: "ch04-shipping-mark", chapterId: "ch-04", chapterLabel: "第4章", group: "合同", term: "运输标志", english: "Shipping Mark", definition: "外包装上用于识别收发货人、目的地和件号的标记。", usage: "应与单据、箱唛和目的港要求一致，避免清关或提货时无法识别。", relatedRoute: "/contract/packing-clause" },
